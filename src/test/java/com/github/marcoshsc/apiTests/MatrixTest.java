...
import com.github.marcoshsc.orsApiTools.matrix.parameters.Metrics;
import com.github.marcoshsc.orsApiTools.matrix.parameters.ResolveLocations;
...
//        req.getParameters().setSources(new Sources(UtilityFunctions.getIntegerList(0, 17)));
//        req.getParameters().setDestinations(new Destinations(new Integer[] {0,1,2,3,4,5,6,7}));
//        req.getParameters().setDestinations(new Destinations(UtilityFunctions.getIntegerList(110, 180)));
