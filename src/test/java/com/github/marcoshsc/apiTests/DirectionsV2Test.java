...
public class DirectionsV2Test {

    @Test
    public void simpleTest() throws IOException, InvalidParameters, RequestException {
...
//                new Coordinate(-43.177,-19.807)
        ...
        req.getParameters().setExtraInfo(new ExtraInfo(Arrays.asList(ExtraInfoEnum.SURFACE)));
